...
const rules = [
  ...
  "К каждой активности обязательно приложите фото из приложения или с часов. Если такой возможности нет — сфотографируйте себя рядом с местом или инвентарём для спортивной активности.",
