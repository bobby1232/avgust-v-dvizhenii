...
export const activities = pgTable("activities", {
  ...
  evidencePhotos: jsonb("evidence_photos").$type<string[]>().notNull().default([]),
...
export const contestSettings = pgTable("contest_settings", {
  ...
  publishEachActivityEnabled: boolean("publish_each_activity_enabled").notNull().default(false),
