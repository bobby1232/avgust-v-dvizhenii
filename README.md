...
| `TELEGRAM_REPORT_THREAD_ID` | ID темы (ветки) групповой ленты; бот публикует в неё и ставит ❤ входящим сообщениям |
...
Чтобы публиковать ленту в теме форума и отмечать сообщения участников сердцем, задайте
`TELEGRAM_REPORT_THREAD_ID`, добавьте бота администратором группы и разрешите реакцию ❤ для темы.
